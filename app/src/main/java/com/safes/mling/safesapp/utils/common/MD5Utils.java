...
public class MD5Utils {
    ...
    public static String getPass(int passLenth) {
        ...
        for (int i = 0; i < passLenth; i++) {
            ...
            strbu.append(buffer.charAt(r.nextInt(range)));
        }
        return strbu.toString();
    }

    public String toDigestLowCaseDiget(String original, String accet){
        String decodeString = toDigest(toDigest(original).toLowerCase() + accet).toLowerCase();
        return decodeString;
    }
    /*
     * 加密方法
